...
import 'package:perezyeregui/widgets/presentaciones/seguro_movilidad.dart';

class SegurosMovilidadScreen extends StatelessWidget {
  const SegurosMovilidadScreen({super.key});
